...
std::tuple<double, double> getPositionPince(){
	...
	alpha=convertToDegre(dxl_lecture, interval, PI);
	...
	beta=convertToDegre(dxl_lecture, interval, PI);
	...
	gamma=convertToDegre(dxl_lecture, interval, PI);
