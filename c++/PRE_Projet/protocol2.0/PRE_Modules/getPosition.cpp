...
Position getPositionPince(){
	...
	getPositionPince.y = 0.077+d1*sin(alpha-deltaAlpha)+d2*sin(beta-PI/2+alpha)+d3*sin(gamma-beta-alpha+PI);     //// rajouter 0.077
...
Position getPositionB(){
	...
	getPositionB.y = 0.077+d1*sin(alpha-deltaAlpha)+d2*sin(beta-PI/2+alpha);     //// rajouter 0.077
	// printf("alpha : %g, beta: %g, gamma: %g\n", alpha,beta,gamma);
	// printf("x1 : %g, y1: %g\n",x1,y1 );
	return getPositionB;
}
...
Position getPositionA(){
	...
	getPositionA.y = 0.077+d1*sin(alpha-deltaAlpha);    //// rajouter 0.077
	// printf("alpha : %g, beta: %g, gamma: %g\n", alpha,beta,gamma);
	// printf("x1 : %g, y1: %g\n",x1,y1 );
	return getPositionA;
}